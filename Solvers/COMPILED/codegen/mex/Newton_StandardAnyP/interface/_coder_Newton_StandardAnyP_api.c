 ...
 *
 * _coder_Newton_StandardAnyP_api.c
 *
 * Code generation for function '_coder_Newton_StandardAnyP_api'
 *
 */
...
void Newton_StandardAnyP_api(const mxArray * const prhs[12], int32_T nlhs, const
  mxArray *plhs[5])
{
  real_T (*w)[4];
  real_T (*lambda)[3];
  ...
  P = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[9]), "P");
  IterMax = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[10]), "IterMax");
  alpha = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[11]), "alpha");

  /* Invoke the target function */
  Newton_StandardAnyP(&st, *X0, *Aeq, *WTarget, *tmin, *tmax, tau1, tau2,
                      *OptimalTension, Tol, P, IterMax, alpha, *w, *lambda,
                      &N_Iter, &InfeasibleFlag, &LineIter);
...
/* End of code generation (_coder_Newton_StandardAnyP_api.c) */
